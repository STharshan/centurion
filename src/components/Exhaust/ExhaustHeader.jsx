...
export default function ExhaustsHero() {
    return (
        <section className="py-10 ">
            <div className="container mx-auto px-4 text-center mt-45">
                ...
                <p className="text-xl text-muted-foreground text-balance max-w-3xl mx-auto mb-8">
                    Your car’s exhaust system plays a vital role in maintaining fuel efficiency, reducing harmful emissions, and keeping you safe by preventing toxic gases from entering the cabin. Regular inspections help ensure both performance and safety.
                </p>
