...
export default function ExhaustsBook() {
    return (
        <section className="py-15 bg-red-600 text-white">
            <div className="container mx-auto px-4 text-center">
                <h2 className="text-3xl font-bold mb-4">Book Your Exhaust Inspection Today</h2>
                <p className="text-xl mb-8 opacity-90">
    Don’t wait until a small issue turns into a costly repair. Book your professional exhaust system inspection today and keep your vehicle running safely, efficiently, and smoothly. Our skilled technicians provide fast, reliable service using the latest diagnostic tools.
                </p>
