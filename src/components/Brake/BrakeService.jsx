...
const servicesData = [
  {
    ...
    icon: FiShield,
    features: [
      "Brake disc and pad inspection & replacement",
      "Brake fluid checks and replacement",
      "Caliper and hydraulic system inspection",
      "Genuine, manufacturer-approved parts",
      "Professional fitting by skilled technicians",
      "Full safety check after replacement"
    ],
  },
  {
    title: "Why Regular Brake Maintenance Matters",
    icon: FiTool,
    features: [
      "Protects you and your passengers on the road",
      "Prevents costly damage to discs, calipers, and other components",
      "Ensures smoother, quieter, and more efficient braking",
      "Extends the life of your braking system",
    ],
  },
];

export default function BrakeServices() {
  return (
