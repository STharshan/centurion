...
export default function BrakeCTA() {
    return (
        <section className="py-15 bg-red-600 text-white">
            <div className="container mx-auto px-4 text-center">
                <h2 className="text-3xl font-bold mb-4">Book Your Brake Check Today</h2>
                <p className="text-xl mb-8 opacity-90">
Don’t take chances with your safety. If you’ve noticed any of the warning signs—or it’s been a while since your last brake inspection—book a brake check today. Our technicians provide honest advice, quality parts, and reliable service to keep you safe on the road.
                </p>
