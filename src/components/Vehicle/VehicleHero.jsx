        ...
        <section className="py-10 ">
            <div className="container mx-auto px-4 text-center mt-45">
                ...
                <h1 className="text-4xl md:text-6xl font-bold text-balance mb-6">
                    Stay Safe, Drive Confident
                </h1>

                {/* Subheading */}
                <p className="text-xl text-muted-foreground text-balance max-w-3xl mx-auto mb-8">
                    Our comprehensive vehicle safety assessments are designed to keep you, your passengers, and others on the road protected. From essential safety checks to detailed inspections, we make sure your car meets the highest safety standards—giving you confidence every time you drive.
                </p>
