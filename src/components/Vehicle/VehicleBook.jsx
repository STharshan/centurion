    ...
    return (
        <section className="py-15 bg-red-600 text-white">
            <div className="container mx-auto px-4 text-center">
                <h2 className="text-3xl font-bold mb-4">Book Your Safety Assessment Today</h2>
                <p className="text-xl mb-8 opacity-90">
Stay ahead of potential issues and make sure your vehicle is always road-ready. Our skilled technicians carry out thorough checks using modern diagnostic equipment—fast, honest, and hassle-free.
                </p>
