...
export default function GhostBook() {
    return (
        <section className="py-15 bg-red-600 text-white">
            <div className="container mx-auto px-4 text-center">
                <h2 className="text-3xl font-bold mb-4">Book Your Ghost Immobiliser Installation Today</h2>
                <p className="text-xl mb-8 opacity-90">
                    Don’t leave your car vulnerable. Book your professional Ghost Immobiliser installation today and protect your vehicle with a world-class security system, installed by our expert technicians. Safe, discreet, and reliable service every time.
                </p>
