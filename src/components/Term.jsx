  ...
  return (
    <section className="bg-black text-white mx-auto px-4 py-8">
      <div className="max-w-6xl mx-auto mt-50">
        <h1
          className="text-3xl font-semibold text-center mb-6 mt-20"
        ...
        <p
          ...
          data-aos="fade-up" // Date text animation
          data-aos-delay="200"
        >
        ...
        <div className="mt-8 space-y-6">
          ...
          <section data-aos="fade-up" data-aos-delay="600">
            ...
            <p className="text-white">
              All content on this website (including text, images, graphics, and logos) is owned by or licensed to Centurion Fast Fit.
          ...
          <section data-aos="fade-up" data-aos-delay="1200">
            ...
            <div className="text-white">
              <p><strong>Centurion Fast Fit</strong></p>
              <p>Email: <a href="mailto:centurionfastfit@gmail.com" className="text-red-500 hover:underline">centurionfastfit@gmail.com</a></p>
              <p>Phone: 02476 638999</p>
              <p>Address: 9A Colledge Road, Holbrooks, Coventry CV6 4BH</p>
            </div>
          </section>
        </div>
      </div>
