...
const BatteryAbout = () => {
  ...
  active:scale-95 active:shadow-[0_0_30px_6px_rgba(220,38,38,0.9)]">
                        <h2 className="text-xl font-semibold">
                           How We Keep You Road-Ready
                        </h2>
                        <p className="text-xl font-semibold mt-4">
  Unlike a quick DIY swap, our professional service ensures your battery is fitted correctly, your charging system is inspected, and any underlying electrical issues are identified before they cause bigger problems.
                        </p>
                    </div>
