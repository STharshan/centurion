...
export default function ShockCTA() {
    return (
        <section className="py-15 bg-red-600 text-white">
            <div className="container mx-auto px-4 text-center">
                <h2 className="text-3xl font-bold mb-4">Book Your Shock Absorber & Suspension Check Today</h2>
                <p className="text-xl mb-8 opacity-90">
                    Don’t compromise on safety or comfort. Book your professional suspension inspection today, and our skilled technicians will ensure your shock absorbers and suspension system are performing at their best. Fast, reliable service with genuine parts for long-lasting results.
                </p>
