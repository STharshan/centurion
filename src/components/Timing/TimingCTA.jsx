...
export default function TimingCTA() {
    return (
        <section className="py-15 bg-red-600 text-white">
            <div className="container mx-auto px-4 text-center">
                <h2 className="text-3xl font-bold mb-4">Book Your Timing Belt Service Today</h2>
                <p className="text-xl mb-8 opacity-90">
                    Don’t wait for a breakdown—timing belt failure often comes without warning. Our skilled technicians replace your belt quickly, professionally, and with genuine parts for lasting peace of mind.
                </p>
