...
export default function ReviewPage() {
    ...
    const EMAILJS_SERVICE_ID = 'service_404lxe7'; // Replace with your EmailJS service ID
    const EMAILJS_TEMPLATE_ID = 'template_wzd0spg'; // Replace with your EmailJS template ID
    const EMAILJS_PUBLIC_KEY = 'tmUgtXKf_TwGrV1iE'; // Replace with your EmailJS public key

    const handleStarClick = (starRating) => {
        setRating(starRating);
        setError('');
        setSubmitted(false);
        setLoading(false); // Reset loading state when clicking a new star

        if (starRating <= 3) {
            // Show review box for 1-3 stars
            setShowReviewBox(true);
        } else {
            // Open Google reviews in a new tab for 4-5 stars
            setShowReviewBox(false);
            window.open("https://www.google.com/search?sca_esv=434108a22045feca&rlz=1C1KNTJ_enLK1089LK1089&sxsrf=AE3TifOLRaSUWi6V0Sidi1wpnBAi-VNP-g:1766063677429&si=AMgyJEtREmoPL4P1I5IDCfuA8gybfVI2d5Uj7QMwYCZHKDZ-E3K4MbTW4DTX9kSYe2ayxg1NKUul_4RiojjXnzNPbSZOYY0QUqRxG0tRZW3tTyI7nkJT-Xpo_hj51KL4psGB8bPjYX_PhUdLFtGodv3GrIBaUYEYwA%3D%3D&q=Centurion+Fast+Fit+Reviews&sa=X&ved=2ahUKEwiZ8JLxm8eRAxUzZyoJHZekEisQ0bkNegQISRAE&biw=1366&bih=633&dpr=1", "_blank", "noopener,noreferrer");
        }
    };
    ...
    const handleSubmit = async (e) => {
        ...
        const templateParams = {
            to_name: 'Business Owner', // You can customize this
            customer_name: name,
                ...
                <div className="bg-white rounded-3xl shadow-2xl shadow-orange-200/50 overflow-hidden backdrop-blur-sm">
                    ...
                    <div className="px-6 sm:px-8 md:px-12 py-8 sm:py-10 md:py-12">
                        ...
                        <div className="mb-8">
                            ...
                            <div className="flex justify-center items-center gap-2 sm:gap-3 md:gap-4">
                                {[1, 2, 3, 4, 5].map((star) => (
                                    <button
                                        ...
                                        className="transform transition-all duration-200 hover:scale-110 focus:outline-none focus:ring-4 focus:ring-orange-300 rounded-full p-1"
                            ...
                            {rating > 0 && (
                                <p className="text-center mt-4 text-lg sm:text-xl font-semibold text-orange-600 animate-fade-in">
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-4">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                required
                                                className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-orange-400 focus:ring-4 focus:ring-orange-100 outline-none transition-all text-sm sm:text-base"
                                        ...
                                        <div>
                                            ...
                                            <textarea
                                                ...
                                                required
                                                rows={5}
                                                className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-orange-400 focus:ring-4 focus:ring-orange-100 outline-none transition-all resize-none text-sm sm:text-base"
